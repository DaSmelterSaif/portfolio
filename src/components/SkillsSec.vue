...
<template>
    ...
    <section id="skills" class="bg-bg-dark lg:px-30 px-10 md:py-20 sm:py-10 py-30">
        <div>
            ...
            <div class="grid lg:grid-rows-1 lg:grid-cols-3 grid-rows-3 gap-20">
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="font-inclusive-sans text-sub-title-font text-text text-center mb-4">Web Development &
                        Programming
                    </h3>
                    <p class="font-roboto-flex text-body-font text-text-muted text-center lg:px-0 px-[13vw]">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="font-inclusive-sans text-sub-title-font text-text text-center mb-4">Machine Learning & AI
                    </h3>
                    <p class="font-roboto-flex text-body-font text-text-muted text-center lg:px-0 px-[13vw]">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="font-inclusive-sans text-sub-title-font text-text text-center mb-4">Arduino</h3>
                    <p class="font-roboto-flex text-body-font text-text-muted text-center lg:px-0 px-[13vw]">
